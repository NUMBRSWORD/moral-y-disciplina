...
// "TNTE. RIOS PAREDES Diego" o "S2 PNP GOMEZ PRADO").
...
// Una mayúscula por palabra ("MARIO ENRIQUE" -> "Mario Enrique"). Para cuando
...
// ("VARGAS SOTO, Mario Enrique"). Los apellidos se mantienen en mayúsculas
...
// solo para mostrar/imprimir, nunca toca el dato guardado. Para cuando
// apellidos y nombres YA vienen en campos separados (el investigado en una
// nota, no el padrón de efectivos), usa nombreCompletoVisible() en vez de esta.
...
// campos separados -- el investigado de una nota, nunca el string combinado
// "apellidos_nombres" del padrón de efectivos.
