...
// Texto del descuento de una persona (o del total): "S/ 138.93", "INDETERMINADO"
// si NINGÚN caso tiene monto de grado, o "S/ 45.83 + INDETERMINADO" si solo
// algunos. Es lo que se ve hasta que se cargue el monto del grado que falta.
export function textoDescuento({ monto, sinMonto }, totalCasos) {
  if (!sinMonto) return formatearSoles(monto);
  if (sinMonto >= totalCasos) return INDETERMINADO;
