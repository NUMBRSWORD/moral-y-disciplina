...
import { agruparPersonas, buscarPersonas, horasDelCaso, formatearDuracion, resumenPersona, resumenDelMes, PERIODO_TODO } from "./personas.js";
...
describe("resumenDelMes", () => {
  ...
  test("todo el período acumula a través de los meses", () => {
    const todo = resumenDelMes(NOTAS, PERIODO_TODO, AHORA);
  ...
  test("todo el período no cuenta expedientes sin fecha de falta", () => {
    const r = resumenDelMes([n({ fecha_falta: null }), n({ fecha_falta: "2026-09-02" })], PERIODO_TODO, AHORA);
