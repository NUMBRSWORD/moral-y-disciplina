...
import { fechaLima, hoyLima } from "./fechas.js";
...
export function construirDatosArchivoLeve(nota, efectivos, seleccion) {
  ...
  return {
    ...
    lugar_fecha: `${nota.lugar || "[LUGAR POR CONFIRMAR]"}, ${fechaLarga(hoyISO)}`,
    ...
    fecha_notificacion: nota.imputacion_generada_at ? fechaLarga(fechaLima(nota.imputacion_generada_at)) : "",
