...
export function buildCasoConcreto(nota) {
  ...
  return (
    `El investigado se encontraba nombrado según el rol de servicio de la Comisaría PNP Ventanilla${enElServicio} para el turno de las ${horaFalta} horas del ${fechaFaltaCorta}; ` +
