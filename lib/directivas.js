...
//
// Objetivo: que la IA de esta aplicación (redacción de la Orden de Sanción y
// el asistente de consulta flotante) se base en el texto REAL de directivas
// vigentes que el admin carga aquí — por ejemplo, los requisitos para que un
// descanso médico particular sea considerado exonerante — en vez de que la
// IA "adivine" ese tipo de reglas institucionales. Si no hay una directiva
// cargada sobre algo, la IA debe decirlo en vez de inventar el requisito.
