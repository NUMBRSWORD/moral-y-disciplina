    ...
    <div class="detail-card">
      ...
      ${puedeInformeAdmin ? `
        ...
        <form id="informeAdminForm">
          ...
          <label>Cargo<input type="text" id="iaConformeCargo" placeholder="Ej. Responsable de la unidad" /></label>
    ...
    <div class="directiva-card cumplimiento-card" data-id="${d.id}" data-version="${d.version}">
      ...
      ${miFirma ? "" : `
        <form class="firma-form" data-documento-id="${d.id}" data-version="${d.version}">
          ...
          <label>Cargo <input type="text" class="firma-cargo-input" required placeholder="Ej. Responsable del expediente" /></label>
